                    ...
                    >
                        <View style={styles.formContent}>
                            ...
                            <View style={styles.modalBuyNft}>
                                ...
                                <Text numberOfLines={1} style={[styles.text, styles.modalBuyNftName]}>NFT Name</Text>
                            ...
                            <View style={styles.modalBuyAction}>
                                <Button style={[styles.btn, styles.modalBuyBtnOk]} onPress={() => { onShowToastSuccess("Congratulation for you!!!")}}>
