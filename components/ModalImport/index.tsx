                    ...
                    >
                        <View style={styles.formContent}>
                            ...
                            <View style={styles.modalImportTitle}>
                                ...
                                <Text numberOfLines={1} style={[styles.text, styles.modalImportTitleCont]}>Import Address</Text>
                                <Text style={[styles.text, styles.modalImportTitleDes]}>Enter address you want to import</Text>
                            </View>
