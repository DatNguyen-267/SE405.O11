...
const ModalSend = ({ item, index, isVisible, setIsVisible }) => {
                ...
                <View style={styles.modalSendForm}>
                    ...
                    >
                        ...
                        <View style={styles.modalSendTitle}>
                            ...
                            <Text numberOfLines={1} style={[styles.text, styles.modalSendTitleCont]}>Send Token</Text>
                            <Text style={[styles.text, styles.modalSendTitleDes]}>Enter token and address you want to send</Text>
                        </View>
