    ...
    <View style={styles.createScreen}>
      ...
      >
        <View style={styles.containerNoConnect}>
          ...
          <Text style={[styles.text, styles.connectDes]} numberOfLines={3} ellipsizeMode="tail">
            Chainlist is a list of EVM networks. Users can use the information to connect their
            wallets and Web3 middleware providers to the appropriate Chain ID and Network ID to
            connect to the correct chain.
          </Text>
          <View
            style={[
              styles.connectBtn,
              !isAZOID ? styles.connectBtnActive : styles.connectBtnNoActive,
            ]}
          >
            <Image
            ...
            <TouchableOpacity style={[styles.connectBtnContent]} onPress={() => connectGoerli()}>
              ...
              <Text
                ...
                ellipsizeMode="tail"
              >
                Ethereum is the community-run technology powering the cryptocurrency ether (ETH) and
